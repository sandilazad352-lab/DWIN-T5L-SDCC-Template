...
1. **[Hardware Architecture Guide](phase1/HARDWARE_ARCHITECTURE.md)** - Understand the processor, memory layout, and initialization
2. **[Memory Management Guide](phase1/MEMORY_MANAGEMENT.md)** - Learn how memory is organized and optimized
3. **[DGUS Protocol Guide](phase1/DGUS_PROTOCOL_GUIDE.md)** - Master communication with the display
4. **[VP Address Map](phase1/VP_ADDRESS_MAP.md)** - Complete reference of all accessible memory addresses
...
#### 1. **[HARDWARE_ARCHITECTURE.md](phase1/HARDWARE_ARCHITECTURE.md)**
...
#### 2. **[DGUS_PROTOCOL_GUIDE.md](phase1/DGUS_PROTOCOL_GUIDE.md)**
...
#### 3. **[MEMORY_MANAGEMENT.md](phase1/MEMORY_MANAGEMENT.md)**
...
#### 4. **[VP_ADDRESS_MAP.md](phase1/VP_ADDRESS_MAP.md)**
...
- Complete details: [DGUS_PROTOCOL_GUIDE.md § 3.1-3.2](phase1/DGUS_PROTOCOL_GUIDE.md#31-command-0x82-read-vp-host--display)
...
- Full details: [MEMORY_MANAGEMENT.md § 2-3](phase1/MEMORY_MANAGEMENT.md#2-internal-ram-iram---0x00-to-0xff)
...
- Full details: [HARDWARE_ARCHITECTURE.md § 1-2](phase1/HARDWARE_ARCHITECTURE.md#1-processor-architecture)
...
**Configure Hardware**
- [ ] Set up oscillator → [HARDWARE_ARCHITECTURE.md § 1.2](phase1/HARDWARE_ARCHITECTURE.md#12-clock-generation)
- [ ] Initialize timers → [HARDWARE_ARCHITECTURE.md § 6.2](phase1/HARDWARE_ARCHITECTURE.md#62-uart2-5-configuration-registers)
- [ ] Configure UART baud rates → [HARDWARE_ARCHITECTURE.md § 6](phase1/HARDWARE_ARCHITECTURE.md#6-uart-configuration-and-baud-rate-calculation)
- [ ] Set up interrupts → [HARDWARE_ARCHITECTURE.md § 7](phase1/HARDWARE_ARCHITECTURE.md#7-interrupt-priority-and-nesting)

**Implement Communication**
- [ ] Read a VP value → [DGUS_PROTOCOL_GUIDE.md § 3.1](phase1/DGUS_PROTOCOL_GUIDE.md#31-command-0x82-read-vp-host--display)
- [ ] Write a VP value → [DGUS_PROTOCOL_GUIDE.md § 3.2](phase1/DGUS_PROTOCOL_GUIDE.md#32-command-0x83-write-vp-host--display)
- [ ] Calculate CRC → [DGUS_PROTOCOL_GUIDE.md § 8](phase1/DGUS_PROTOCOL_GUIDE.md#8-crc-16modbus-calculation-details)
- [ ] Handle frame errors → [DGUS_PROTOCOL_GUIDE.md § 6](phase1/DGUS_PROTOCOL_GUIDE.md#6-error-handling-and-edge-cases)

**Manage Memory**
- [ ] Allocate buffer in XDATA → [MEMORY_MANAGEMENT.md § 3.5](phase1/MEMORY_MANAGEMENT.md#35-application-data-space-0x3400-0x7fff)
- [ ] Optimize IRAM usage → [MEMORY_MANAGEMENT.md § 2.5](phase1/MEMORY_MANAGEMENT.md#25-optimizing-iram-usage)
- [ ] Understand UART buffers → [MEMORY_MANAGEMENT.md § 3.4](phase1/MEMORY_MANAGEMENT.md#34-circular-buffer-implementation)
- [ ] Reduce code size → [MEMORY_MANAGEMENT.md § 4.4](phase1/MEMORY_MANAGEMENT.md#44-reducing-code-size)

**Design Application**
- [ ] Allocate VP addresses → [VP_ADDRESS_MAP.md § 7](phase1/VP_ADDRESS_MAP.md#7-vp-address-allocation-strategy)
- [ ] Define sensor VP → [VP_ADDRESS_MAP.md § 4.2](phase1/VP_ADDRESS_MAP.md#42-application-vp-example-temperature-sensor)
- [ ] Implement multi-page UI → [VP_ADDRESS_MAP.md § 6](phase1/VP_ADDRESS_MAP.md#6-multi-page-vp-organization)
- [ ] Encode VP values → [VP_ADDRESS_MAP.md § 8](phase1/VP_ADDRESS_MAP.md#8-common-vp-value-ranges-and-encodings)
...
**Steps**:
1. Define VP for temperature → [VP_ADDRESS_MAP.md § 4.2](phase1/VP_ADDRESS_MAP.md#42-application-vp-example-temperature-sensor)
2. Understand temperature encoding → [VP_ADDRESS_MAP.md § 8.1](phase1/VP_ADDRESS_MAP.md#81-temperature-encoding-example)
3. Read sensor value → Application code (see examples)
4. Send to display using 0x83 Write VP → [DGUS_PROTOCOL_GUIDE.md § 3.2](phase1/DGUS_PROTOCOL_GUIDE.md#32-command-0x83-write-vp-host--display)

**Related Documentation**:
- [DGUS_PROTOCOL_GUIDE.md § 5.1](phase1/DGUS_PROTOCOL_GUIDE.md#51-typical-requestresponse-cycle) - Protocol example
- [VP_ADDRESS_MAP.md § 8.1](phase1/VP_ADDRESS_MAP.md#81-temperature-encoding-example) - Value encoding
...
2. Define button VP → [VP_ADDRESS_MAP.md § 3.4](phase1/VP_ADDRESS_MAP.md#324-button-press-counters-0x0400-0x04ff)
3. Monitor auto-upload data → [DGUS_PROTOCOL_GUIDE.md § 5.2](phase1/DGUS_PROTOCOL_GUIDE.md#52-auto-upload-mode-display--host)
...
1. **[HARDWARE_ARCHITECTURE.md](phase1/HARDWARE_ARCHITECTURE.md)** (complete read)
   - Sections: 1, 2, 3, 5, 6, 7
   - Focus: Processor details, memory layout, register configuration

2. **[MEMORY_MANAGEMENT.md](phase1/MEMORY_MANAGEMENT.md)** (complete read)
   - Sections: 1-6, 9
   - Focus: IRAM/XDATA layout, optimization, debugging

3. **[DGUS_PROTOCOL_GUIDE.md](phase1/DGUS_PROTOCOL_GUIDE.md)** (sections 1-4)
   - Focus: Protocol overview, frame structure, addressing

### For Firmware Developers
1. **[DGUS_PROTOCOL_GUIDE.md](phase1/DGUS_PROTOCOL_GUIDE.md)** (complete read)
   - Focus: Implementation details, examples, CRC

2. **[VP_ADDRESS_MAP.md](phase1/VP_ADDRESS_MAP.md)** (sections 1-5, 8)
   - Focus: VP allocation, access patterns, encodings

3. **[HARDWARE_ARCHITECTURE.md](phase1/HARDWARE_ARCHITECTURE.md)** (sections 2, 6, 7)
   - Focus: Memory map, baud rates, interrupts

4. **[MEMORY_MANAGEMENT.md](phase1/MEMORY_MANAGEMENT.md)** (sections 2-3, 5-6)
   - Focus: Buffer allocation, optimization

### For Application Development
1. **[VP_ADDRESS_MAP.md](phase1/VP_ADDRESS_MAP.md)** (complete read)
   - Focus: VP allocation, multi-page design, encodings

2. **[DGUS_PROTOCOL_GUIDE.md](phase1/DGUS_PROTOCOL_GUIDE.md)** (sections 5-7)
   - Focus: Communication patterns, practical examples

3. **[MEMORY_MANAGEMENT.md](phase1/MEMORY_MANAGEMENT.md)** (sections 3.5)
   - Focus: Application space allocation

### For System Architects / Project Managers
1. **[HARDWARE_ARCHITECTURE.md](phase1/HARDWARE_ARCHITECTURE.md)** (sections 1, 2.1)
   - Focus: System overview, memory capacity

2. **[MEMORY_MANAGEMENT.md](phase1/MEMORY_MANAGEMENT.md)** (sections 1, 5)
   - Focus: Resource bottlenecks, stress points

3. **[VP_ADDRESS_MAP.md](phase1/VP_ADDRESS_MAP.md)** (sections 7)
...
### [PROTOCOL_EXAMPLES.md](phase2/PROTOCOL_EXAMPLES.md)
...
### [DEBUGGING_GUIDE.md](phase2/DEBUGGING_GUIDE.md)
...
### [TIMER_CLOCK_GUIDE.md](phase2/TIMER_CLOCK_GUIDE.md)
...
### [INTERRUPT_SYSTEM_GUIDE.md](phase2/INTERRUPT_SYSTEM_GUIDE.md)
...
### [ASIC_FEATURES_GUIDE.md](phase3/ASIC_FEATURES_GUIDE.md)
...
### [PERFORMANCE_METRICS.md](phase3/PERFORMANCE_METRICS.md)
...
**Memory Organization**
- IRAM: [HARDWARE_ARCHITECTURE.md § 2.1](phase1/HARDWARE_ARCHITECTURE.md#21-iram-organization), [MEMORY_MANAGEMENT.md § 2](phase1/MEMORY_MANAGEMENT.md#2-internal-ram-iram---0x00-to-0xff)
- XDATA: [HARDWARE_ARCHITECTURE.md § 2.3](phase1/HARDWARE_ARCHITECTURE.md#23-xdata-layout-for-this-project), [MEMORY_MANAGEMENT.md § 3](phase1/MEMORY_MANAGEMENT.md#3-external-data-ram-xdata---0x0000-to-0x7fff)
- Flash: [HARDWARE_ARCHITECTURE.md § 2.4](phase1/HARDWARE_ARCHITECTURE.md#24-flash-rom-organization), [MEMORY_MANAGEMENT.md § 4](phase1/MEMORY_MANAGEMENT.md#4-flash-memory-program-memory)

**Communication Protocol**
- Frame Format: [DGUS_PROTOCOL_GUIDE.md § 2](phase1/DGUS_PROTOCOL_GUIDE.md#2-frame-structure)
- Commands: [DGUS_PROTOCOL_GUIDE.md § 3](phase1/DGUS_PROTOCOL_GUIDE.md#3-command-set-reference)
- Examples: [DGUS_PROTOCOL_GUIDE.md § 7](phase1/DGUS_PROTOCOL_GUIDE.md#7-practical-protocol-examples)

**Virtual Processor (VP) Addressing**
- Overview: [VP_ADDRESS_MAP.md § 1](phase1/VP_ADDRESS_MAP.md#overview)
- System VPs: [VP_ADDRESS_MAP.md § 2](phase1/VP_ADDRESS_MAP.md#2-system-vp-addresses-0x0000-0x00ff)
- Application VPs: [VP_ADDRESS_MAP.md § 4](phase1/VP_ADDRESS_MAP.md#4-user-application-vp-space-0x4000-0x7fff)

**Hardware Control**
- Registers: [HARDWARE_ARCHITECTURE.md § 3](phase1/HARDWARE_ARCHITECTURE.md#3-special-function-registers-sfr)
- Clock: [HARDWARE_ARCHITECTURE.md § 1.2](phase1/HARDWARE_ARCHITECTURE.md#12-clock-generation), [HARDWARE_ARCHITECTURE.md § 6](phase1/HARDWARE_ARCHITECTURE.md#6-uart-configuration-and-baud-rate-calculation)
- Interrupts: [HARDWARE_ARCHITECTURE.md § 7](phase1/HARDWARE_ARCHITECTURE.md#7-interrupt-priority-and-nesting)
...
- **Communication Issues** → [DGUS_PROTOCOL_GUIDE.md § 11](phase1/DGUS_PROTOCOL_GUIDE.md#11-troubleshooting-protocol-issues)
- **Memory Problems** → [MEMORY_MANAGEMENT.md § 9](phase1/MEMORY_MANAGEMENT.md#9-memory-bottlenecks--solutions)
- **Hardware Configuration** → [HARDWARE_ARCHITECTURE.md § 10](phase1/HARDWARE_ARCHITECTURE.md#10-verification-checklist)
- **VP Address Conflicts** → [VP_ADDRESS_MAP.md § 9](phase1/VP_ADDRESS_MAP.md#9-vp-address-conflicts-and-resolution)
